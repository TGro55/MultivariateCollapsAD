...
\AW{comments
 \begin{itemize}
     ...
     \item Fig. 1 wird nicht referenziert, ich teile die Bedenken, dass die Graphik sehr ähnlich ist, ich mache mal für Sec. 2 einen neuen Vorschlag
 \end{itemize}
...
\section{[Not done] Methodology}\label{sec:methodology}
...
\input{paper/sections/appendix_linearity_for_taylor}
