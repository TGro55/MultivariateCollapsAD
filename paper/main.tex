...
\begin{abstract}
  Computing high-order derivatives of high-dimensional functions via nested backpropagation becomes prohibitively expensive in time and memory, severely restricting their utility in scientific machine learning.
  ...
  Recent advances, such as the forward Laplacian and randomized Taylor mode, propose enhanced forward-mode automatic differentiation schemes to address this challenge.
  We unify and generalize these schemes, proposing a modified version of Taylor-mode AD that ``collapses'' highest-order derivatives by leveraging linearity in the computational graph, and demonstrate how general PDE operators can be reformulated to exploit this optimization.
