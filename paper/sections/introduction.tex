...
Although nesting first-order automatic differentiation (AD) to compute high-order derivatives scales exponentially in time and memory, this approach is common practice \cite[][\S3.2]{shi2024stochastic}.
