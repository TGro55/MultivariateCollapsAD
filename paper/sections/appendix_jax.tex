...
Doing so, we encountered a bug when trying to \texttt{jit}-compile the \texttt{folx} implementation (indicated by the \texttt{jit} column in \Cref{tab:jax-benchmark}).
