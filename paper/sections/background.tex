...
\todo{AW: It is difficult to fit also the number of the equation ointo the line, therefore I deleted the number and will reformulate the reference to this equation}
