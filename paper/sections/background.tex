...
\end{align*}
and requires the $K$-jet of $\vx$, $(J^K \vx)(t) := \sum_{k=0}^K \frac{t^k}{k!} \vx_k$ (illustrated in \cref{fig:utp}). $J^K \vf$ is sometimes also considered differently as a mapping $(\vx_0, \dots, \vx_K) \mapsto (\vf_0, \dots, \vf_K)$ \cite{bradbury2018jax}, because we are interested in the coefficients, not the Taylor polynomial itself.
