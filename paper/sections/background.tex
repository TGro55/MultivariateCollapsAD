...
In summary, this yields the following propagation scheme:
\begin{align}\label{eq:taylor-mode-composition}
  ...
  \end{split}
\end{align}
\Cref{eq:taylor-mode-composition} describes the forward propagation of a single $K$-jet.
...
We show that this accumulation can be pulled inside Taylor mode's propagation scheme, which collapses the $K$-th component.
