...
\end{equation}
\todo{T: use 1-norm!}
The summation ranges over the set $\left\{ \vm = (m_1, \dots, m_I) \in \mathbb{N}^I \mid m_1 \leq i_1, \dots, m_I \leq i_I, |\vm| > 0 \right\}$. Furthermore, we utilize the generalized binomial coefficient
\begin{equation}
    \left(
       \begin{matrix}
        a \\
