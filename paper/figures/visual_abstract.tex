...
\begin{figure*}
  ...
  \savebox{\taylorStandardNew}{
    \begin{tikzpicture}
      ...
      \draw [-Stealth, line width=2pt, purple!50!red]
      ($(taylor-10-3.south east)+(0, 2.75ex)$)
      -- ($(taylor-10-3.south east)+(0, 6.05ex)$);

      \draw [-Stealth, line width=2pt, purple!50!red]
      ($(taylor-10-3.south east)+(0, 10.5ex)$)
      -- ($(taylor-10-3.south east)+(0, 7.2ex)$);
      ;

      \draw [purple!50!red, line width=3pt]
      ($(taylor-10-3.south east)+(-1.25ex, 6.625ex)$)
      -- ($(taylor-10-3.south east)+(1.25ex, 6.625ex)$);
    \end{tikzpicture}
  }
