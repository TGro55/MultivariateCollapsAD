\begin{figure}[!h]
  ...
  \scalebox{0.58}{
    \begin{tikzpicture}
      ...
      row sep=4ex,%
        ...
        \& \node[state, replicate] (x0-d) {x0\_r = replicate(x0)};
        \&
  ...
  \scalebox{0.58}{
    \begin{tikzpicture}
      ...
      (x0) edge [arrow] (f0)
      (f0) edge [arrow] (f0-d)
      (x0-d) edge [arrow, out=-30, in=170] (df-d)
      (f0-d) edge [arrow] (d2f-d)
      (df-d) edge [arrow] (f1-d)
      (x1-d) edge [arrow, out=18, in=175] (f1-d)
      (d2f-d) edge [arrow] (temp2-d)
  ...
  \scalebox{0.58}{
    \begin{tikzpicture}
      ...
      row sep=4ex,%
        ...
        \\
        \node[state, leaf] (x1-d) {x1\_r};
        \& \node[state, replicate] (d2f-d) {d2f\_r = replicate(-f0)};
        \& \node[state, replicate] (df-d) {df\_r = replicate(df)};
        \& \node[state, output] (f1-d) {f1\_r = 
        einsum(``...,...\\->...'', df\_r, x1\_r)};
        \\
        \&
      ...
      (df) edge [arrow, out=-50, in=120] (df-d)
      (f0) edge [arrow] (d2f-d)
      (df-d) edge [arrow] (f1-d)
      (x1-d) edge [arrow, out=18, in=175] (f1-d)
      (d2f-d) edge [arrow] (temp2-d)
  ...
  \scalebox{0.58}{
    \begin{tikzpicture}
      ...
      row sep=4ex,%
        ...
        \\
        \node[state, leaf] (x2-d) {x2\_r};
        \& \node[state] (temp2-d) {temp2\_d = einsum(``...,r...\\->r...'', d2f, x2\_r)};
        \& \node[state] (f2-d) {f2\_r = temp1\_r + temp2\_r};
        \& \node[state, output] (f2) {f2 = sum(f2\_r, dim=0)};
        \\
      };
