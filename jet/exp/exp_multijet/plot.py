...
from jet.exp.exp_multijet.run import EXPERIMENTS
from jet.exp.exp_multijet.run import savepath as savepath_gathered
...
LABELS = {
    ...
    "jet_naive": "Naive jet",
    "jet_simplified": "Collapsed jet",  ### Add for multijet : deleted '(ours)'
    "multijet_naive": "Naive multi-jet",
    "multijet_simplified": "Collapsed multi-jet",
    "multijet_sym_naive": "Naive multi-jet",
    "multijet_sym_simplified": "Collapsed multi-jet",
}
